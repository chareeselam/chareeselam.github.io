...
A media-based web project that curates themed content in Are.na and uses its API to build an interactive interface for exploring the collection.
3. Binding - https://chareeselam.github.io/binding/
A responsive, multi-page website that curates prior typographic work into a cohesive digital book.
4. Spread - https://chareeselam.github.io/spread/
A collaborative typographic web project I built with Soko Solongo focused on responsive design and consistency across mobile, desktop, and print.
5. Manuscript - https://chareeselam.github.io/manuscript/
A typographic response to Everyday Color Theory by Cortney Cassidy, interpreting the essay through hierarchy, expression, and form. The first website I ever coded.
